...
public class PublicApi {
    ...
    /**
     * Build call for v1PublicSummaryGet
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PublicSummaryGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/public/summary";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PublicSummaryGetValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = v1PublicSummaryGetCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PublicSummaryResponse v1PublicSummaryGet() throws ApiException {
        ApiResponse<PublicSummaryResponse> resp = v1PublicSummaryGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * Summary
     * 
     * @return ApiResponse&lt;PublicSummaryResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PublicSummaryResponse> v1PublicSummaryGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = v1PublicSummaryGetValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<PublicSummaryResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PublicSummaryGetAsync(final ApiCallback<PublicSummaryResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PublicSummaryGetValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PublicSummaryResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
